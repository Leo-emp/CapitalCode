  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '100%' }}>
      ...
      <div style={safeZoneStyle}>
        <div style={{ borderLeft: `4px solid ${colors.accent.gold}`, paddingLeft: 32, maxWidth: '75%', opacity: progress, transform: `translateX(${(1 - progress) * -20}px)` }}>
          <div style={{ fontFamily: fonts.body.family, fontSize: fontSize('body', 'large', aspect), color: colors.text.primary, fontStyle: 'italic', lineHeight: 1.6 }}>"{truncate(quote, 150)}"</div>
